...
Let's get started by logging into Expanse with your account either via the [Expanse User Portal](https://portal.expanse.sdsc.edu) or directly via SSH from a terminal application.
